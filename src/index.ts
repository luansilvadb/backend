...
// Configurar Swagger UI - Interface oficial que funciona no Vercel
const swaggerUiOptions = {
  customCss: '.swagger-ui .topbar { display: none }',
  customSiteTitle: 'Dashboard Backend API',
  swaggerOptions: {
    url: '/api-docs.json',
    ...
    <pre>POST /api/export/por-filtro/filtro_1234567890
{
  ...
  "Cargo": "Desenvolvedor"
    ...
    <ul>
      <li><code>GET /api/sheets/{id}/abas</code> - Lista abas</li>
      <li><code>POST /api/sheets/criar-aba</code> - Cria nova aba</li>
      <li><code>POST /api/sheets/salvar-dados</code> - Salva dados</li>    </ul>    <h2>🔗 Links</h2>
    <p><a href="/api-docs">📖 Documentação Swagger UI interativa</a></p>
    <p><strong>Ferramentas para testar a API:</strong></p>
    <ul>
      <li>📄 <a href="/api-docs.json">Swagger JSON</a> - Use no <a href="https://editor.swagger.io" target="_blank">Swagger Editor</a></li>
      <li>🧪 Use Postman, Insomnia ou outras ferramentas de teste de API</li>
      <li>📖 Interface interativa diretamente em <a href="/api-docs">api-docs</a></li>
    </ul>
